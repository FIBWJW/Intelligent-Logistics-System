 ...
 * employee 员工表
 */
public class sourceMysqlToHdfs09 {
        ...
        ugi.doAs(new java.security.PrivilegedExceptionAction<Void>() {
            ...
            public Void run() throws Exception {
                ...
                DebeziumSourceFunction<String> build = MySQLSource.<String>builder()
                        ...
                        .tableList("lyzTestzhu.province_order_summary")
                ...
                //输出数据路径
                String hdfsOutputPath = "hdfs://bigdata:9000/datashuju/ads_province_order_summary";
