 ...
 * employee 员工表
 */
public class sourceMysqlToHdfs06 {
        ...
        ugi.doAs(new java.security.PrivilegedExceptionAction<Void>() {
            ...
            public Void run() throws Exception {
                ...
                DebeziumSourceFunction<String> build = MySQLSource.<String>builder()
                        ...
                        .tableList("lyzTestzhu.logistics_vehicle_summary")
                ...
                //输出数据路径
                String hdfsOutputPath = "hdfs://bigdata:9000/datashuju/dwd_logistics_vehicle_summary";
