 ...
 * employee 员工表
 */
public class sourceMysqlToHdfs08 {
        ...
        ugi.doAs(new java.security.PrivilegedExceptionAction<Void>() {
            ...
            public Void run() throws Exception {
                ...
                DebeziumSourceFunction<String> build = MySQLSource.<String>builder()
                        ...
                        .tableList("lyzTestzhu.logistics_status_summary")
                ...
                //输出数据路径
                String hdfsOutputPath = "hdfs://bigdata:9000/datashuju/ads_logistics_status_summary";
