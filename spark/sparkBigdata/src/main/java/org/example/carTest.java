        ...
        while (true){
            try {
                ...
                Dataset<Row> provinceCount = df
                        .withColumn("car_type", functions.regexp_extract(df.col("car_type"), "^([^,]+)", 1))
                        .groupBy("car_type")
                        .count()
...
//        spark.stop();
        ...
        result.repartition(partitions)
                ...
                .foreachPartition(new VoidFunction<Iterator<Row>>() {
                    ...
                    public void call(Iterator<Row> partition) throws Exception {
                        ...
                        String sql = "INSERT INTO car_type_num(car_type,count)" +
                                "VALUES(?,?)";
    ...
    public static void deleteDFtoDB() {
        ...
        try {
            ...
            String sql = "DELETE FROM car_type_num  WHERE 1 = 1";
